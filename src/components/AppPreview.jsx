    ...
    <section className="bg-[#FFF7F5] pb-16">
      <div className="MyContainer grid grid-cols-2 items-center">
        ...
        <div className="flex justify-end">
          ...
          <p className="text-[#1E1E1E] text-[24px] max-w-150 leading-relaxed mb-10">
          ...
          <div className="flex gap-12">
            <div>
              <h4 className="text-5xl font-semibold text-gray-900">95%</h4>
              <p className="text-[20px] text-gray-600">User Satisfaction</p>
            </div>

            <div>
              <h4 className="text-5xl font-semibold text-gray-900">4.7</h4>
