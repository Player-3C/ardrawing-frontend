...
export default function Hero() {
  return (
    <section className="bg-[#FFF7F5] h-[90vh] flex items-center">
      ...
      >
        <div>
          <h1 className="text-[42px] md:text-[48px] font-extrabold md:leading-tight text-black">
            <span
              className="
            bg-linear-to-r
            from-[#FF6B6B]
          ...
          <p className="mt-6 text-black text-[22px] leading-7 tracking-[0.02em]">
        ...
        <div className="relative w-full md:w-[80%] h-[600px] ml-auto">
          <Image
            src="/images/hero.png"
            alt="AR Drawing"
            fill
