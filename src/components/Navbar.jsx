...
export default function Navbar() {
  ...
  return (
    <header className="w-full bg-[#FFF1EE] border-b-2 border-[#FFB3AA]">
      <nav className="MyContainer flex items-center justify-between md:gap-10 lg:gap-20 h-[12vh] md:h-[12vh] relative">
        {/* Logo */}
        ...
        <div className="flex items-center justify-center w-full md:gap-10 lg:gap-20">
          <ul className="hidden md:flex items-center gap-10 text-[18px] md:text-[20px] lg:text-[24px] font-semibold text-gray-900">
            {menuItems.map((item) => (
              <li key={item}>
                <a
