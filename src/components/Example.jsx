          ...
          <form className="lg:col-span-2 px-4 md:px-6 py-4">
            ...
            <div className="mt-8">
              ...
              <textarea
                ...
                className="mt-2 w-full bg-transparent border-b border-gray-400 focus:outline-none focus:border-black resize-none h-24 text-[15px]"
              />
            </div>
...
function Input({ label, value, onChange }) {
  return (
    <div>
      <label className="text-[16px] font-medium text-gray-800">{label}</label>
      <input
        type="text"
        value={value}
        onChange={(e) => onChange(e.target.value)}
        className="mt-2 w-full bg-transparent border-b border-gray-400 focus:outline-none focus:border-black text-[16px]"
      />
    </div>
  );
}
