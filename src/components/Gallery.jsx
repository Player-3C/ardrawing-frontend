  ...
  return (
    <section className="bg-[#FFF7F5] pt-16 pb-10 overflow-hidden">
      <div className="MyContainer">
        ...
        <p className="mt-2 md:mt-4 text-center text-[#1e1e1e] text-[16px] md:text-[18px] lg:text-[24px] max-w-5xl mx-auto">
        ...
        <div className="grid gap-6">
          ...
          <div className="grid grid-cols-12 gap-6 md:pt-16 pt-8">
            ...
            <div className="col-span-12 sm:col-span-6 md:col-span-3 flex flex-col gap-6">
              <div className="h-60 md:h-42 lg:h-60 bg-[#FFA3A229] border border-[#FFB3AA] rounded-[22px] flex items-center justify-center">
                <Image
            ...
            <div className="col-span-6 md:col-span-4 flex flex-col gap-6">
              <div className="h-75 md:h-51 lg:h-75 bg-[#FFA3A229] border border-[#FFB3AA] rounded-[22px] flex items-center justify-center">
                <Image
              ...
              <div className="h-45 md:h-33 lg:h-45 bg-[#FFA3A229] border border-[#FFB3AA] rounded-[22px] flex items-center justify-center">
                <Image
