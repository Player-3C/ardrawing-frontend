...
export default function Faq() {
  const [openIndex, setOpenIndex] = useState(1); // ✅ 2nd FAQ open
            ...
            return (
              ...
              >
                <button
                  ...
                  className="w-full flex items-center justify-between px-8 py-5 text-left font-medium text-gray-900 text-[16px] md:text-[20px] lg:text-[24px]"
                >
                  {faq.question}
                  <ChevronDown
                    size={20}
                ...
                >
                  <p className="text-gray-600 md:text-[18px] lg:text-[20px] text-[16px] leading-relaxed">
                    {faq.answer}
                  </p>
                </div>
              </div>
