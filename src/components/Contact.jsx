      ...
      <section className="MyContainer">
        <div className=" bg-[#FFE9E5] border border-[#FFB3AA] rounded-[50px] shadow-2xl px-9 py-12">
          <div className="grid items-center gap-3">
            <h2 className="text-4xl md:text-6xl font-extrabold text-center text-black tracking-wide">
              Boost Your Drawing Skills
            </h2>

            <p className="mt-4 text-center text-gray-700 text-[26px] max-w-6xl mx-auto">
